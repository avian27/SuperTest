...
describe('Forgot Password @cdm', async()=>{
    it('Forgot Password - empty string sent as email id', async()=>{
...
describe('Update Password @cdm', async() => {
    
    it('Update Password - User is not logged in', async()=>{
        payload = JSON.stringify({
    ...
    it('Update Password - Empty string as password', async()=>{
        payload = JSON.stringify({
            "password": ``
        });
        signed_headers = getSignedRequestHeaders("POST", baseUrl, updatePasswordApiEndPoint, payload, {});
    ...
    it('Update Password - Length of Password is 7', async()=>{
        payload = JSON.stringify({
    ...
    it('Update Password - Existing Password is sent', async()=>{
        payload = JSON.stringify({
    ...
    it('Update Password - Valid Password is sent', async()=>{
        payload = JSON.stringify({
    ...
    it('Update Password - Resetting the password to original password', async()=>{
        payload = JSON.stringify({
            "password": process.env.TEST_PASS
        });
...
describe('Initialize Email Update @cdm', async()=>{
    it('Initialize Email Update - User not logged in', async()=>{
        payload = JSON.stringify({
    ...
    it('Initialize Email Update - Invalid email sent', async()=>{
        payload = JSON.stringify({
    ...
    it('Initialize Email Update - Email sent is already registerd', async()=>{
        payload = JSON.stringify({
    ...
    it('Initialize Email Update - Unregistered email sent', async()=>{
